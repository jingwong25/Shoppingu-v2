...
angular.module('mean.articles')
  .controller('PostController', ['$scope', '$stateParams', '$state', 'GetTravelByProfileId', '$window', 'GetTravelProductByTravelId', function ($scope, $stateParams, $state, GetTravelByProfileId, $window, GetTravelProductByTravelId) {
    ...
    $scope.deletePost = function (index) {
      ...
      var travel = {
        profileId: $scope.userId,
        travelStatus: TRAVELSTATUS.cancel
      };
